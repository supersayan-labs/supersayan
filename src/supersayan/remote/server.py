    ...
    def get_model(self, model_id: str) -> dict:
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    f"Failed to load model {model_id}: {str(e)} then {str(e2)}"
                )
...
class SupersayanServer:
    ...
    def handle_get_model_structure(self, model_id: str) -> dict:
        ...
        try:
            ...
            return {"structure": {"layer_order": layer_order}}, 200
    ...
    def handle_inference(
        self, model_id: str, layer_name: str, encrypted_input_base64: str
    ) -> dict:
        """
        ...
        try:
            ...
            logger.debug(
                f"Encrypted input received for model {model_id}, layer {layer_name}"
            )
