"""
Benchmark for the Conv2dOrion layer with different input and output sizes.
"""
...
def test_benchmark_conv2d_orion(benchmark, batch_size, in_channels, out_channels, 
                               input_size, kernel_size, stride, padding):
    """Benchmark Conv2dOrion layer with different configurations."""
    # Generate secret key
    key = generate_secret_key()
    
    # Define FHE Orion-optimized convolutional layer
    conv = Conv2dOrion(
