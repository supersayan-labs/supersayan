...
from supersayan.core.bindings import jl, HAS_CUPY, cp
...
skip_cupy = pytest.mark.skipif(not HAS_CUPY or not cuda_available, reason="CuPy not available or CUDA not available")
